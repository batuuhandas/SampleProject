...
public class DriverSettings {
    ...
    public static final String userName = "batuhandas_hdq4VD";
    public static final String userKey = "2z3xWrDQiDio3UHEmts2";

    public static final String URL = "https://" + userName + ":" + userKey + "@hub-cloud.browserstack.com/wd/hub";
